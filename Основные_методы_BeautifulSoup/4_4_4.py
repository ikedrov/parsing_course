# Обработать все теги <img> в предоставленной HTML-строке.
# Извлечь значение атрибута alt для каждого тега <img>. Предполагается, что значения этого атрибута представляют собой целые числа.
# Суммировать все извлеченные значения.
